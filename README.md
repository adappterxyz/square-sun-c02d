...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/square-sun-c02d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/square-sun-c02d
```

A live public deployment of this template is available at [https://square-sun-c02d.templates.workers.dev](https://square-sun-c02d.templates.workers.dev)
